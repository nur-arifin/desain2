        ...
        <div className="mt-10 mx-auto">
          <div className="bg-gray-800 py-10 px-6 rounded-lg">
            <div className="flex flex-col sm:flex-row justify-between ">
              <input
                type="text"
                className="px-4 py-2 border border-gray-300 rounded-md flex-grow mr-2"
                placeholder="Email"
              />
              <button className="px-6 py-2 mr-2 bg-[#B9FF66] text-black rounded-md hover:bg-lime-600 focus:outline-none">
                Subscribe to news
              </button>
            </div>
          </div>
